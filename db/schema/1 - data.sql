...
INSERT INTO users (id, username, password) SELECT 'bfd6ada0-2b46-4971-a314-d5abd7b7ebb1', 'test_admin', '$2a$10$9ff5YsbNNmp5/3dyN0g2WeB.AnA9cnrqH48.i4gKbqI68lmb84VMW' WHERE NOT EXISTS (SELECT * FROM users WHERE id='bfd6ada0-2b46-4971-a314-d5abd7b7ebb1');
