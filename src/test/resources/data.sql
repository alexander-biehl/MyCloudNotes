...
--                                                                                                       'password'
INSERT INTO users (id, username, password) SELECT '5c553179-71b1-4c85-842e-b6ff67dc8e61', 'test_user', '$2y$11$t2/h9Y3rtugyl0tB56MaFOhCVxZnrY3sa.JRrDsmqAa8lZ2qCsl9i' WHERE NOT EXISTS (SELECT * FROM users WHERE id='5c553179-71b1-4c85-842e-b6ff67dc8e61');
INSERT INTO users (id, username, password) SELECT 'bfd6ada0-2b46-4971-a314-d5abd7b7ebb1', 'test_admin', '$2y$11$t2/h9Y3rtugyl0tB56MaFOhCVxZnrY3sa.JRrDsmqAa8lZ2qCsl9i' WHERE NOT EXISTS (SELECT * FROM users WHERE id='bfd6ada0-2b46-4971-a314-d5abd7b7ebb1');
INSERT INTO users (id, username, password) SELECT 'fd210c53-8e93-46c6-81b4-4c3188568619', 'test_user2', '$2y$11$t2/h9Y3rtugyl0tB56MaFOhCVxZnrY3sa.JRrDsmqAa8lZ2qCsl9i' WHERE NOT EXISTS (SELECT * FROM users WHERE id='fd210c53-8e93-46c6-81b4-4c3188568619');
