...
--                                                                                                       'password'
INSERT INTO users (id, username, password) SELECT '5c553179-71b1-4c85-842e-b6ff67dc8e61', 'test_user', '$2a$10$9ff5YsbNNmp5/3dyN0g2WeB.AnA9cnrqH48.i4gKbqI68lmb84VMW' WHERE NOT EXISTS (SELECT * FROM users WHERE id='5c553179-71b1-4c85-842e-b6ff67dc8e61');
